...
static struct ether_header *eh = (struct ether_header *) sendbuf;
...
//    eh->ether_shost[1] = 0x12;
//    eh->ether_shost[2] = 0x17;
//    eh->ether_shost[3] = 0x33;
//    eh->ether_shost[4] = 0xC2;
//    eh->ether_shost[5] = 0xFC;

    eh->ether_shost[0] = 0xFC;
    eh->ether_shost[1] = 0xC2;
    eh->ether_shost[2] = 0x33;
    eh->ether_shost[3] = 0x17;
    eh->ether_shost[4] = 0x12;
